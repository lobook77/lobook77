...
export const Icons = {
  ...
  Arte: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 16a4 4 0 0 0 4-4"/><circle cx="9" cy="9" r="1"/><circle cx="15" cy="9" r="1"/></svg>
  ),
  Map: () => (
